...
This file is the root instruction set for coding agents working on Weatherpane.
...
- Repository-local temporary memory files MUST use the `.memory-*.local.md` naming pattern.
