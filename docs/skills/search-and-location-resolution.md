...
- Escape always cancels pending input before it can update the URL. With an active highlight, Escape restores inputValue from the active URL query and clears the highlight; without an active highlight, it clears the query immediately.
